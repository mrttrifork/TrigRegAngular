...
export class TimeRegistrationService {
    ...
    /**
     * Returns time registrations for a user
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateTimeRegistrationForUser(timeRegistrationId: string, timeRegistrationUpdateRequest: TimeRegistrationUpdateRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<string>;
    public updateTimeRegistrationForUser(timeRegistrationId: string, timeRegistrationUpdateRequest: TimeRegistrationUpdateRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<string>>;
    public updateTimeRegistrationForUser(timeRegistrationId: string, timeRegistrationUpdateRequest: TimeRegistrationUpdateRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<string>>;
    public updateTimeRegistrationForUser(timeRegistrationId: string, timeRegistrationUpdateRequest: TimeRegistrationUpdateRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<any> {
