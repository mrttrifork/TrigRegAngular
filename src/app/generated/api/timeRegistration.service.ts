...
export class TimeRegistrationService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTaskTimeRegistrationsOverview(date: string, period?: 'day' | 'week' | 'month', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<Array<TimeRegistrationsByTaskResponseInner>>;
    public getTaskTimeRegistrationsOverview(date: string, period?: 'day' | 'week' | 'month', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<TimeRegistrationsByTaskResponseInner>>>;
    public getTaskTimeRegistrationsOverview(date: string, period?: 'day' | 'week' | 'month', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<TimeRegistrationsByTaskResponseInner>>>;
    public getTaskTimeRegistrationsOverview(date: string, period?: 'day' | 'week' | 'month', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext, transferCache?: boolean}): Observable<any> {
