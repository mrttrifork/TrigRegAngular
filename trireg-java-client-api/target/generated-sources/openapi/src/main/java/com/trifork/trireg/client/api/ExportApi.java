...
public class ExportApi {
   ...
   */
  public String exportTimeRegistrationsForUser(LocalDate start, LocalDate end) throws ApiException {
    ApiResponse<String> localVarResponse = exportTimeRegistrationsForUserWithHttpInfo(start, end);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<String> exportTimeRegistrationsForUserWithHttpInfo(LocalDate start, LocalDate end) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = exportTimeRegistrationsForUserRequestBuilder(start, end);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("exportTimeRegistrationsForUser", localVarResponse);
        }
  ...
  private HttpRequest.Builder exportTimeRegistrationsForUserRequestBuilder(LocalDate start, LocalDate end) throws ApiException {
    // verify the required parameter 'start' is set
    if (start == null) {
      throw new ApiException(400, "Missing the required parameter 'start' when calling exportTimeRegistrationsForUser");
    }
    // verify the required parameter 'end' is set
    if (end == null) {
      throw new ApiException(400, "Missing the required parameter 'end' when calling exportTimeRegistrationsForUser");
    }
